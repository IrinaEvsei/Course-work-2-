package courseproject.imagemaker.ImageFilters;
 ...
 */
public abstract class AbstractFilter extends AsyncTask<String, String, Bitmap> {

    protected Bitmap src;
    protected Bitmap result;
    protected Activity mActivity;

    public AbstractFilter(Bitmap src, Activity activity) {
        this.src = src;
